    ...
    <>
      <div className={expand ? "items_Links bg-white p-4  scale-100  rounded-md w-[20rem] transition duration-700 ease-in-out ": "items_Links bg-white scale-105  rounded-md p-3  transition duration-700 ease-in-out "}>
        ...
        <div className="log-img flex items-center mb-8">
          <img
            src="https://res.cloudinary.com/dkqp3wkbi/image/upload/v1684417814/stored/gwdtzraibmhmn68e5rce.jpg"
            alt=""
            width={40}
          />
        ...
        <ul className="flex flex-col gap-2">
          <li>
            ...
            text-white
            rounded-full p-1`:`flex items-center text-black hover:bg-gradient-to-r from-cyan-500 to-blue-500
            hover:text-white
            rounded-full p-1`}>
          ...
          <li>
            <NavLink 
            to={`AnBodega/${token}`}    
            className={({isActive}) => isActive ? `flex items-center  bg-gradient-to-r from-cyan-500 to-blue-500
            text-white
            rounded-full p-1`:`flex items-center text-black hover:bg-gradient-to-r from-cyan-500 to-blue-500
            hover:text-white
            rounded-full p-1`}>
          ...
          <li>
            <NavLink to={`AnInventario/${token}`}  className={({isActive}) => isActive ? `flex items-center  bg-gradient-to-r from-cyan-500 to-blue-500
            text-white
            rounded-full p-1`:`flex items-center text-black hover:bg-gradient-to-r from-cyan-500 to-blue-500
            hover:text-white
            rounded-full p-1`}>
          ...
          <li>
                        <NavLink to={`AnProductos/${token}`}  className={({isActive}) => isActive ? `flex items-center  bg-gradient-to-r from-cyan-500 to-blue-500
            text-white
            rounded-full p-1`:`flex items-center text-black hover:bg-gradient-to-r from-cyan-500 to-blue-500
            hover:text-white
            rounded-full p-1`}>
              <span className="bg-gray-100 rounded-full p-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path fill="#3f51b5" d="M28 23v3.586l-5-5V15a1 1 0 0 0-.553-.894L17 11.381V5.828l2.586 2.586L21 7l-5-5l-5 5l1.414 1.414L15 5.828v5.554l-5.447 2.723A1 1 0 0 0 9 15v6.586l-5 5V23H2v7h7v-2H5.414l4.783-4.783l5.356 2.678a1.001 1.001 0 0 0 .894 0l5.356-2.678L26.586 28H23v2h7v-7Zm-13 .382l-4-2v-4.764l4 2Zm1-6.5L12.236 15L16 13.118L19.764 15Zm5 4.5l-4 2v-4.764l4-2Z"/></svg>
              </span>
          ...
          <li>
            <NavLink to={`AnPedidos/${token}`}  className={({isActive}) => isActive ? `flex items-center  bg-gradient-to-r from-cyan-500 to-blue-500
            text-white
            rounded-full p-1`:`flex items-center text-black hover:bg-gradient-to-r from-cyan-500 to-blue-500
            hover:text-white
            rounded-full p-1`}>
          ...
          <li>
            <NavLink to={`AnVentas/${token}`}  className={({isActive}) => isActive ? `flex items-center  bg-gradient-to-r from-cyan-500 to-blue-500
            text-white
            rounded-full p-1`:`flex items-center text-black hover:bg-gradient-to-r from-cyan-500 to-blue-500
            hover:text-white
            rounded-full p-1`}>
          ...
          <li>
            <NavLink to={`AnUsuarios/${token}`}  className={({isActive}) => isActive ? `flex items-center  bg-gradient-to-r from-cyan-500 to-blue-500
            text-white
            rounded-full p-1`:`flex items-center text-black hover:bg-gradient-to-r from-cyan-500 to-blue-500
            hover:text-white
            rounded-full p-1`}>
