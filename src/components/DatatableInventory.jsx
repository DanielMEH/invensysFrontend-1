  ...
  export const DatatableInventory = () => {
    ...
    const [columnDefs, setColumnDefs] = useState([
      ...
      },
      {
        headerName: "Unidades",
        field: "unidad",
        cellStyle: (params) => (params.value >10 ? { color: "#1daf53" } : { color: "red" }),
        chartDataType: 'body',
        filter: "agTextColumnFilter",
      },
      {
      ...
      },
      {
        headerName: "Estado",
        field: "Estado",
        cellStyle: (params) => (params.value === "Activo" ? { color: "#1daf53" } : { color: "red" }),
        chartDataType: 'body',
        filter: "agTextColumnFilter",
      },
    ...
    return (
      <>
      {
        load ? (
          <>
          <div className="container animate__animated animate__fadeInDown rounded-md grid place-content-center mt-10 ">
              <svg
          ...
          < ContextCategory>
             ...
             <div className="panel_opciones  bg-white w-[100%] mx-auto mt-10 mb-1  rounded-md p-4">
               ...
               <section className="items-center flex">
                   ...
                   <div className="users flex items-center mx-2">
                     ...
                     <span className="text-[#3498DB] mx-1">Total de productos</span>
                     <span className="text-[#3498DB] mx-1">{subViewProducts.length}</span>
                   </div>
                 </section>
             ...
             <div className="buttons">
              ...
              <div className="flex items-center border mx-1 p-1 rounded-md">
                   ...
                   <span>Total de unidades : {("+ " + totalUnidades).replace(
                         /(\d)(?=(\d\d\d)+(?!\d))/g,
                         "$1."
                       )} </span>
                 </div>
