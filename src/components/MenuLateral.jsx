...
fixed top-0
  bg-white mr-[10rem]
 w-14 lg:w-48   b shadow-2xl shadow-teal-300/10 z-10 overflow-x-hidden  ">
      ...
      <div className="contenedor_perfil_count flex">
        ...
        >
          <img
            ...
            className="w-8"
          />
          <div className="administrador mx-1 hidden lg:block">Administrador</div>
        ...
        <ul className="p-0 m-0">
          ...
          {users.permisions.includes("perfil") ? (
            ...
            >
              ...
              <div className="NavLinks1 pt-[2px] ml-3 hidden lg:block">Perfil</div>
            </NavLink>
          </li>
          ):null}
          ...
          <li>
            ...
            >
             <button onClick={hundleClick} className="flex 
              ...
              <div className="pt-[2px] ml-3 whitespace-nowrap hidden lg:block"> Cerrar sesión</div>
            </button>
            </NavLink>
          </li>
        </ul>
       ...
       {users.permisions.includes("config") ? (
          ...
          {users.permisions.includes("ayuda") ? (
            ...
            >
              ...
              <div className="pt-[2px] ml-3 whitespace-nowrap hidden lg:block">Ayuda</div>
            </NavLink>
          </li>
          ):null}
