          ...
          <div className="content_users m-7">
            <div className="content_users_title">
              ...
              <div className="ctfg mt-4">
                <Link
                  to="AllVentas"
                  className=" whitespace-nowrap dark:text-white  hover:bg-gray-200 p-1 hover:rounded-full hover:border-none flex items-center w-fit border-b-2 border-[#019afa]  "
                >
