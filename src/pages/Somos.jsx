...
<div class="contten-1 mk-kodiar">
 <div class="title">
     <h1 class="my-4 text-xl font-bold dark:text-white">¿Quienes Somos?</h1>
    </div>
     
    <div class="description">
    <article class="my-6">
     <p class="p dark:text-white">Invensys, creada en 2022, es una aplicación dedicada a la prestacion de servicios de Admistración, soportada con infraestructura tecnica y tecnologica, capaz de brindar a nuestros usuarios calidad en la prestación de sus servicios.</p>
     <p class="p dark:text-white">A través de la prestación de nuestros servicios de Administración hemos logrado intoducir a las tiendas de la ciudad de Armenia a tener un manejo permanente de su inventario cuidadosamente para satisfacer las necesidades y expectativas de todos los miembros de esta comunidad, logrando asi consolidar y posicionar este servicio.</p>
    </article>
    </div>
 
    <div class="mision">
     <div class="title-3">
         <h2 class="my-4 text-xl font-bold dark:text-white">
             Nuestra Misión
             </h2>
        </div>
        <article>
    ...
    <div class="vision">
     <h2 class="my-4 text-xl font-bold dark:text-white">Nuestra Visión</h2>
     ...
     <div class="valores">
         <h2 class="my-4 text-xl font-bold dark:text-white">Nuestros Valores</h2>
         
         <p class="p dark:text-white">
