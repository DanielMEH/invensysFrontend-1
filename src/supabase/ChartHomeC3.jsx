     ...
     <Skeleton
      ...
      <div className=" flex gap-2 ">
        <section className="bg-white shadow-lg w-[20rem] px-5 py-2 rounded-md my-5">
          ...
          <div className="ventasNumm ">
            <span className="text-xl font-bold p-2 block">
              {("$ " + TotalVentas).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")}
            </span>
          </div>
          <div className="static flex">
            ...
            <span className="text-[#4ade80]">{porcentage + "%"} Estable </span>
          </div>
          <div className="my-1">
        ...
        <section className="bg-white shadow-lg w-[20rem] px-5 py-2 rounded-md my-5">
          ...
          <div className="ventasNumm ">
            <span className="text-xl font-bold p-2 block">
              {("$ " + TotalCompras).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")}
            </span>
          </div>
          <div className="static flex">
            <svg
        ...
        <section className="bg-white shadow-lg w-[20rem] px-5 py-2 rounded-md my-5">
          ...
          <div className="ventasNumm ">
            <span className={diferencia < 0 ? "text-xl font-bold p-2 text-red-500 block truncate ":" truncate text-green-500 text-xl font-bold p-2 block"}>
          ...
          <div className="my-1">
            <span className="mx-2">{compras.length+ ventas.length }</span>Productos en movimiento
          </div>
        </section>
        <section className="bg-white shadow-lg w-[18rem] px-5 py-2 rounded-md my-5">
          ...
          <div className="ventasNumm flex">
            <span className={" truncate text-green-500 text-xl font-bold p-2 block"}>
              Activos: {
                activos.length
              }
            </span>
            <span className={ "text-xl font-bold p-2 text-red-500 block truncate "}>
              Inactivos: {
                inactivos.length
              }
            </span>
